...
public class MemberDAO implements IMemberDAO
{
	...
	public int add(MemberDTO member) throws SQLException
	{
		...
		//Connection conn = dataSource.getConnection("scott", "tiger");		//--??
		Connection conn = dataSource.getConnection();
		
		PreparedStatement pstmt = null;
		String sql = "";
		
		sql = "INSERT INTO TBL_MEMBERLIST(MID, NAME, TELEPHONE)"
	...
	public int count() throws SQLException
	{
		...
		sql ="SELECT COUNT(*) AS COUNT FROM TBL_MEMBERLIST";
		pstmt = conn.prepareStatement(sql);
	...
	public ArrayList<MemberDTO> list() throws SQLException
	{
		...
		sql = "SELECT MID, NAME, TELEPHONE FROM TBL_MEMBERLIST ORDER BY MID";
