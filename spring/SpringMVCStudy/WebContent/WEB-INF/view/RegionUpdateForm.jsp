	...
	<div>
		...
		<form action="regionupdate.action" method="post" id="regionForm">
			<table>
				<tr>
					<th>지역번호</th>
					<td><input type="text" id="id" name="id" placeholder="지역번호" readonly="readonly" value="${region.regionId}"></td>
				</tr>
				<tr>
					<th>지역명</th>
					<td><input type="text" id="name" name="name" placeholder="지역명" value="${region.regionName}"></td>
				</tr>
				<tr>
