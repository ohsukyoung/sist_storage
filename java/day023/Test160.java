...
public class Test160
{
	...
	public static void main(String[] args)
	{
		...
		// ○ 오른차순 정렬 후 전체 출력
		System.out.println("오름차순 정렬 후 전체 출력: " );
		for (String str : v )
			System.out.print(str + " ");
		System.out.println();
		//--==>> 오름차순 정렬 후 전체 출력:
		...
		// 검색기능 수행
		// 단, 오름차순 정렬이 수행되어 있는 자료에대해서만 사용이 가능하다. check~!!!
		// 검색 결과가 존재하지 않을 경우 음술를 반환한다.
		...
		System.out.printf("분홍: %d번째 인덱스에 위치하고 있다.", idxPink);
		System.out.println();
		//--==>> 분홍: -2번째 인덱스에 위치하고 있다.
		//--		→ 즉, 분홍은 v에 존재하지 않는다.
