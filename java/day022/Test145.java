...
○ java.lang.Math 클래스는
	...
	생성자가 있긴 하지만... privat  으로 선언되어 있기 때문에
	외부에서 객체(인스턴스)를 생성할 수 없다.
	단, 모든 메소드가 static  으로 정의되어 있으므로
	객체를 생성하지않고 바로 접근하여 사용하는 것이 가능하낟.
...
○ java.lang.Math 클래스의 주요 상수 및 메소드
	...
	- public static doule exp(double a)
		: e 의 a 승을 구하여 반환한다.
	...
	- public static double ceil(double a)
		: a 보다 크거나 같은 정수를 반환한다.(올림개념)

	- public static double floor(double a)
		: a 보다 작거나 같은 정수르 반환한다.(절삭개념)
...
public class Test145
{
	public static void main(String[] args)
	{
		...
		//--==>> 0.0 ~ 1.0 사이의 난수: 0.5649528154348337
		//		0.0 ~ 1.0 사이의 난수: 0.31303756447865194
		//		0.0 ~ 1.0 사이의 난수: 0.4091848167562987
	}
}