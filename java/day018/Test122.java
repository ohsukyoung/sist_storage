...
○ 중첩 클래스
	...
	특정 클래스를 마치 자신의 멤버 젼수나 메소드처럼 사용할 수 있게 한다.
...
2. 내부 클래스(inner class)
	...
	- static 으로 선언된 변수 또는 메소드르 가질 수 없다.
...
class Test
{
	...
	public static class StaticNested			//-- static
	{
		...
		void write()
		{
			...
			//System.out.println("b: " + b);	// 에러 발생: static이 먼저 생성되고 b는 나중에 만들어짐
